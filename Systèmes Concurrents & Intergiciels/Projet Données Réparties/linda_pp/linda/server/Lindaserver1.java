...
public class Lindaserver1 extends UnicastRemoteObject implements Lindaserver {
	...
	static String servers[] = {"Lindaserver2", "Lindaserver3", "Lindaserver4"};
	static int ports[] = {4001, 4002, 4003};
	
	
	// Constructeur initialisant linda utilisée avec une autre déjà définie
	public Lindaserver1(CentralizedLinda linda) throws RemoteException {
		this.linda = linda;
	}
	
	// Constructeur créant un nouveau linda
	public Lindaserver1() throws RemoteException {
