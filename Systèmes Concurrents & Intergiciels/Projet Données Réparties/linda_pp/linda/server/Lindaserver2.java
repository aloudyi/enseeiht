...
public class Lindaserver2 extends UnicastRemoteObject implements Lindaserver {
	...
	static String servers[] = {"Lindaserver3", "Lindaserver4", "Lindaserver1"};
	static int ports[] = {4002, 4003, 4000};
	
	
	// Constructeur initialisant linda utilisée avec une autre déjà définie
	public Lindaserver2(CentralizedLinda linda) throws RemoteException {
		this.linda = linda;
	}
	
	// Constructeur créant un nouveau linda
	public Lindaserver2() throws RemoteException {
