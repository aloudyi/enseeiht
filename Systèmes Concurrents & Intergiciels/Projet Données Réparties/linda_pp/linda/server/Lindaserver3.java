...
public class Lindaserver3 extends UnicastRemoteObject implements Lindaserver {
	...
	static String servers[] = {"Lindaserver4", "Lindaserver1", "Lindaserver2"};
	static int ports[] = {4003, 4000, 4001};
	
	
	// Constructeur initialisant linda utilisée avec une autre déjà définie
	public Lindaserver3(CentralizedLinda linda) throws RemoteException {
		this.linda = linda;
	}
	
	// Constructeur créant un nouveau linda
	public Lindaserver3() throws RemoteException {
