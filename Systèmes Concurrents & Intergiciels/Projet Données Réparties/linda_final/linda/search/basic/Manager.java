...
public class Manager implements Runnable {
    ...
    private void addSearch(String search) {
        ...
        linda.eventRegister(Linda.eventMode.TAKE, Linda.eventTiming.IMMEDIATE, new Tuple(Code.Result, this.reqUUID, String.class, Integer.class), new CbGetResult(search));
    ...
    private class CbGetResult implements linda.Callback {
    	private String search;
    	public CbGetResult(String search) {
    		this.search = search;
    	}
        public void call(Tuple t) {  // [ Result, ?UUID, ?String, ?Integer ]
            ...
            if (v < bestvalue) {
                bestvalue = v;
                bestresult = s;
                System.out.println("New best for "+search+" (" + bestvalue + "): \"" + bestresult + "\"");
            }
