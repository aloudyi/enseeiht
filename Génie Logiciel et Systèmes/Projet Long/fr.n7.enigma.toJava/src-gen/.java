...
public class  {
	...
	public static void Initialiser_Territoire( enigme) {
	...
	private static void Initialiser_Joueur( enigme) {
		ArrayList<Objet> objets = new ArrayList<Objet>();
		ArrayList<Connaissance> connaissances = new ArrayList<Connaissance>();
		enigme.joueur = enigme.new Joueur(invalid, 1, objets, connaissances);
	}
