 ...
 *   <li>{@link fr.n7.eNIGMA.impl.LieuImpl#getPersonnes <em>Personnes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LieuImpl extends JeuElementImpl implements Lieu
{
  ...
  public EList<Personne> getPersonnes()
  {
    if (personnes == null)
    {
      personnes = new EObjectContainmentEList<Personne>(Personne.class, this, ENIGMAPackage.LIEU__PERSONNES);
    }
    return personnes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ENIGMAPackage.LIEU__PERSONNES:
