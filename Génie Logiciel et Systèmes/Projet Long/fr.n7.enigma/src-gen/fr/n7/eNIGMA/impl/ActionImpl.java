 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.eNIGMA.impl.ActionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.eNIGMA.impl.ActionImpl#getObjetsconsommables <em>Objetsconsommables</em>}</li>
 *   <li>{@link fr.n7.eNIGMA.impl.ActionImpl#getObjetsattribuables <em>Objetsattribuables</em>}</li>
 *   <li>{@link fr.n7.eNIGMA.impl.ActionImpl#getConnaissancesattribuables <em>Connaissancesattribuables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends JeuElementImpl implements Action
{
  ...
  /**
   * The cached value of the '{@link #getObjetsconsommables() <em>Objetsconsommables</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getObjetsattribuables() <em>Objetsattribuables</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ENIGMAPackage.ACTION__NAME, oldName, name));
  }
  ...
  public EList<Objet> getObjetsconsommables()
  {
    ...
    {
      objetsconsommables = new EObjectContainmentEList<Objet>(Objet.class, this, ENIGMAPackage.ACTION__OBJETSCONSOMMABLES);
    }
  ...
  public EList<Objet> getObjetsattribuables()
  {
    ...
    {
      objetsattribuables = new EObjectContainmentEList<Objet>(Objet.class, this, ENIGMAPackage.ACTION__OBJETSATTRIBUABLES);
    }
  ...
  public EList<Connaissance> getConnaissancesattribuables()
  {
    ...
    {
      connaissancesattribuables = new EObjectResolvingEList<Connaissance>(Connaissance.class, this, ENIGMAPackage.ACTION__CONNAISSANCESATTRIBUABLES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ENIGMAPackage.ACTION__OBJETSCONSOMMABLES:
        return ((InternalEList<?>)getObjetsconsommables()).basicRemove(otherEnd, msgs);
      case ENIGMAPackage.ACTION__OBJETSATTRIBUABLES:
        return ((InternalEList<?>)getObjetsattribuables()).basicRemove(otherEnd, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ENIGMAPackage.ACTION__NAME:
        return getName();
      case ENIGMAPackage.ACTION__OBJETSCONSOMMABLES:
        return getObjetsconsommables();
      case ENIGMAPackage.ACTION__OBJETSATTRIBUABLES:
        return getObjetsattribuables();
      case ENIGMAPackage.ACTION__CONNAISSANCESATTRIBUABLES:
