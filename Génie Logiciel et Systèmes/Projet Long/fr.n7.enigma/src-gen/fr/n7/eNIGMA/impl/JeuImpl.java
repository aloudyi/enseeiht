 ...
 *   <li>{@link fr.n7.eNIGMA.impl.JeuImpl#getJeuelement <em>Jeuelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JeuImpl extends MinimalEObjectImpl.Container implements Jeu
{
  ...
  public EList<JeuElement> getJeuelement()
  {
    if (jeuelement == null)
    {
      jeuelement = new EObjectContainmentEList<JeuElement>(JeuElement.class, this, ENIGMAPackage.JEU__JEUELEMENT);
    }
    return jeuelement;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ENIGMAPackage.JEU__JEUELEMENT:
