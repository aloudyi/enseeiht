 ...
 *   <li>{@link fr.n7.eNIGMA.impl.JoueurImpl#getLimite <em>Limite</em>}</li>
...
public class JoueurImpl extends JeuElementImpl implements Joueur
{
  ...
  public void setLimite(int newLimite)
  {
    ...
    limite = newLimite;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ENIGMAPackage.JOUEUR__LIMITE, oldLimite, limite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ENIGMAPackage.JOUEUR__NAME:
        return getName();
      case ENIGMAPackage.JOUEUR__LIMITE:
        return getLimite();
      case ENIGMAPackage.JOUEUR__OBJETS:
        return getObjets();
      case ENIGMAPackage.JOUEUR__CONNAISSANCES:
