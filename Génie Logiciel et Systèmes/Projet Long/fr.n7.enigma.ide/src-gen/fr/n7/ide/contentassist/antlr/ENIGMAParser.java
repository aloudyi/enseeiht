...
public class ENIGMAParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ENIGMAGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConnaissanceAccess().getQualificationAssignment_2(), "rule__Connaissance__QualificationAssignment_2");
			builder.put(grammarAccess.getConnaissanceAccess().getEtatvAssignment_4(), "rule__Connaissance__EtatvAssignment_4");
			builder.put(grammarAccess.getConnaissanceAccess().getEtatpAssignment_5(), "rule__Connaissance__EtatpAssignment_5");
			builder.put(grammarAccess.getObjetAccess().getNameAssignment_1(), "rule__Objet__NameAssignment_1");
			builder.put(grammarAccess.getObjetAccess().getOccurrenceAssignment_3(), "rule__Objet__OccurrenceAssignment_3");
			builder.put(grammarAccess.getObjetAccess().getTailleAssignment_7(), "rule__Objet__TailleAssignment_7");
			builder.put(grammarAccess.getObjetAccess().getEtatvAssignment_9(), "rule__Objet__EtatvAssignment_9");
			builder.put(grammarAccess.getObjetAccess().getEtatpAssignment_10(), "rule__Objet__EtatpAssignment_10");
			...
			builder.put(grammarAccess.getReponseAccess().getTexteAssignment_5(), "rule__Reponse__TexteAssignment_5");
			builder.put(grammarAccess.getReponseAccess().getActionAssignment_7(), "rule__Reponse__ActionAssignment_7");
